...
(function () {
    $(function () {
        ...
        var _editTextModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Sys/Languages/EditTextModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Sys/Views/Languages/_EditTextModal.js',
        ...
        $('#CreateNewLanguageTextButton').click(function (e) {
            _editTextModal.open({
                sourceName: $('#TextSourceSelectionCombobox').val(),
                baseLanguageName: $('#TextBaseLanguageSelectionCombobox').val(),
                languageName: $('#TextTargetLanguageSelectionCombobox').val(),
