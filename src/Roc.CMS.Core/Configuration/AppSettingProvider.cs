    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        private IEnumerable<SettingDefinition> GetHostSettings()
        {
            return new[] {
                ...
                new SettingDefinition(AppSettings.UiManagement.Footer.Skin,GetFromAppSettings(AppSettings.UiManagement.Footer.Skin,"light"),isVisibleToClients:true,scopes: SettingScopes.All),
