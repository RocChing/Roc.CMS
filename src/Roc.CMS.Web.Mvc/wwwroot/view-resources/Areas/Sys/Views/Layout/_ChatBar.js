    ...
    getFormattedMessages: function (messages) {
        $.each(messages, function (index, message) {
            ...
            if (message.message.startsWith('[image]')) {
                ...
                var fileUrl = abp.appPath + 'Sys/Chat/GetImage?id=' + message.id + '&contentType=' + image.contentType;
                ...
                var fileUrl = abp.appPath + 'Sys/Chat/GetFile?id=' + message.id + '&contentType=' + file.contentType;
...
(function ($) {
    $(function () {
        ...
        var url = abp.appPath + 'Sys/Chat/UploadFile';
