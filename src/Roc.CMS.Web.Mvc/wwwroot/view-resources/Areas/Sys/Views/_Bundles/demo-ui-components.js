...
$(function () {
    ...
    var url = abp.appPath + 'Sys/DemoUiComponents/UploadFile';
    $('#fileupload').fileupload({
        ...
        maxFileSize: 999000,
            ...
            if (jsonResult.success) {
                var fileUrl = abp.appPath + 'Sys/DemoUiComponents/GetFile?id=' + jsonResult.result.id + '&contentType=' + jsonResult.result.contentType;
