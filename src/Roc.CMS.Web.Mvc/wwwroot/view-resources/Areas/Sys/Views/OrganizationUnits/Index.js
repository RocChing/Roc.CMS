(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Sys/OrganizationUnits/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Sys/Views/OrganizationUnits/_CreateModal.js',
            modalClass: 'CreateOrganizationUnitModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Sys/OrganizationUnits/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Sys/Views/OrganizationUnits/_EditModal.js',
            modalClass: 'EditOrganizationUnitModal'
        });

        var _addUserModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Sys/OrganizationUnits/AddMemberModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Sys/Views/OrganizationUnits/_AddMemberModal.js',
