(function ($) {
    $(function () {
        ...
        var mySettingsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Sys/Profile/MySettingsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Sys/Views/Profile/_MySettingsModal.js',
        ...
        var changePasswordModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Sys/Profile/ChangePasswordModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Sys/Views/Profile/_ChangePasswordModal.js',
        ...
        var changeProfilePictureModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Sys/Profile/ChangePictureModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Sys/Views/Profile/_ChangePictureModal.js',
        ...
        var userLoginAttemptsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Sys/Users/LoginAttemptsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Sys/Views/Users/_LoginAttemptsModal.js',
        ...
        var manageLinkedAccountsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Sys/Profile/LinkedAccountsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Sys/Views/Profile/_LinkedAccountsModal.js',
