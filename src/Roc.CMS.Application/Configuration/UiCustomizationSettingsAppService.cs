...
namespace Roc.CMS.Configuration
{
    ...
    public class UiCustomizationSettingsAppService : AbpZeroTemplateAppServiceBase, IUiCustomizationSettingsAppService
    {
        ...
        public async Task<UiCustomizationSettingsEditDto> GetUiManagementSettings()
        {
            return new UiCustomizationSettingsEditDto
            {
                ...
                Footer = new UiCustomizationFooterSettingsEditDto()
                {
                    ...
                    FooterSkin = await _settingManager.GetSettingValueAsync(AppSettings.UiManagement.Footer.Skin)
                }
            };
        }
        ...
        private async Task<UiCustomizationSettingsEditDto> GetHostUiManagementSettings()
        {
            return new UiCustomizationSettingsEditDto
            {
                ...
                Footer = new UiCustomizationFooterSettingsEditDto
                {
                    ...
                    FooterSkin = await _settingManager.GetSettingValueForApplicationAsync(AppSettings.UiManagement.Footer.Skin)
                }
            };
        }
        ...
        private async Task<UiCustomizationSettingsEditDto> GetTenantUiCustomizationSettings()
        {
            ...
            return new UiCustomizationSettingsEditDto
            {
                ...
                Footer = new UiCustomizationFooterSettingsEditDto
                {
                    ...
                    FooterSkin = await _settingManager.GetSettingValueForTenantAsync(AppSettings.UiManagement.Footer.Skin, tenantId)
                }
            };
        }
        ...
        private async Task UpdateTenantUiManagementSettingsAsync(UiCustomizationSettingsEditDto settings)
        {
            ...
            if (!string.IsNullOrEmpty(settings.Footer.FooterSkin))
            {
                await _settingManager.ChangeSettingForTenantAsync(tenantId, AppSettings.UiManagement.Footer.Skin, settings.Footer.FooterSkin);
            }
        }
        ...
        private async Task UpdateApplicationUiManagementSettingsAsync(UiCustomizationSettingsEditDto settings)
        {
            ...
            if (!string.IsNullOrEmpty(settings.Footer.FooterSkin))
            {
                await _settingManager.ChangeSettingForApplicationAsync(AppSettings.UiManagement.Footer.Skin, settings.Footer.FooterSkin);
            }
        }
        ...
        private async Task UpdateUserUiManagementSettingsAsync(UiCustomizationSettingsEditDto settings)
        {
            ...
            if (!string.IsNullOrEmpty(settings.Footer.FooterSkin))
            {
                await _settingManager.ChangeSettingForUserAsync(userIdentifier, AppSettings.UiManagement.Footer.Skin, settings.Footer.FooterSkin);
            }
        }
    }
}