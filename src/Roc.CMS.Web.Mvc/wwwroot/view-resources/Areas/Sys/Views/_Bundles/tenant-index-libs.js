...
(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + "Sys/Tenants/CreateModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Sys/Views/Tenants/_CreateModal.js",
            modalClass: "CreateTenantModal"
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + "Sys/Tenants/EditModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Sys/Views/Tenants/_EditModal.js",
            modalClass: "EditTenantModal"
        });

        var _featuresModal = new app.ModalManager({
            viewUrl: abp.appPath + "Sys/Tenants/FeaturesModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Sys/Views/Tenants/_FeaturesModal.js",
