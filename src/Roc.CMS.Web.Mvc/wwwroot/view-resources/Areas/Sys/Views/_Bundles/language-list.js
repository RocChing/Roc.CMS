...
(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Sys/Languages/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Sys/Views/Languages/_CreateOrEditModal.js',
            ...
            columnDefs: [
                {
                    ...
                    rowAction: {
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                document.location.href = abp.appPath + "Sys/Languages/Texts?languageName=" + data.record.name;
                            }
                        }, {
